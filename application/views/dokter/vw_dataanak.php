        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex flex-wrap justify-content-between align-items-center">
                    ...
                    <a href="<?= base_url('Export/anak') ?>" class="btn btn-success">
							...
							<tbody>
								<?php foreach ($rekam_medis as $key => $rm): ?>
									   <tr>
										   <td><?= $key + 1 ?></td>
										   <td>
											   <a href="<?= base_url('Dokter/detailResep/' . $rm['id_rekam']) ?>"
												   class="btn btn-primary">Detail Resep</a>
										   </td>
										   ...
										   <td>
											...
											<td>
												<a href="<?= base_url('Dokter/detail_data_rekammedis/' . $rm['id_rekam']); ?>"
													class="badge badge-warning">Detail</a>
												<a href="<?= base_url('Dokter/update_rekam_medis/' . $rm['id_rekam']); ?>"
													class="badge badge-primary">Update</a>
												<a href="<?= base_url('Dokter/hapus_rekam_medis/' . $rm['id_rekam']); ?>"
