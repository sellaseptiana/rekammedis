					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card" style="background-color: rgba(245, 245, 245, 0.9);">
								<div class="card-header">
									<center>
										<h4 class="title"><strong>Update Data Rekam Medis KB</strong></h4><br>
									</center>
...
<div class="form-group row">
    <label class="col-sm-4 col-form-label">Jumlah Anak Hidup</label>
    <div class="col-sm-12">
...
<div id="anak_hidup_details" style="display: none;">
    <div class="form-group row">
        <label class="col-sm-4 col-form-label">Jumlah Anak Laki-laki</label>
        <div class="col-sm-12">
    ...
    <div class="form-group row">
        <label class="col-sm-4 col-form-label">Jumlah Anak Perempuan</label>
        <div class="col-sm-12">
...
<div class="form-group row">
    <label class="col-sm-4 col-form-label">Umur Anak Terkecil</label>
    <div class="col-sm-12">
...
<div class="form-group row">
    <label class="col-sm-4 col-form-label">Status Peserta KB</label>
    <div class="col-sm-12">
...
<div class="form-group row">
    <label class="col-sm-4 col-form-label">Cara KB Terakhir</label>
    <div class="col-sm-12">
...
<div class="form-group row">
    <label class="col-sm-4 col-form-label">Haid Terakhir</label>
    <div class="col-sm-12">
...
<div class="form-group row">
    <label class="col-sm-4 col-form-label">Hamil/Diduga Hamil</label>
    <div class="col-sm-12">
...
<div class="form-group row"><label for="gravida"
													class="col-sm-4 col-form-label"> Jumlah GPA
												</label>
											</div>
<div class="form-group row">
    <label for="gravida" class="col-sm-4 col-form-label">Gravida (Kehamilan)</label>
    <div class="col-sm-12">
...
<div class="form-group row">
    <label for="partus" class="col-sm-4 col-form-label">Partus (Persalinan)</label>
    <div class="col-sm-12">
...
<div class="form-group row">
    <label for="abotus" class="col-sm-4 col-form-label">Abotus (Keguguran)</label>
    <div class="col-sm-12">
...
<div class="form-group row">
    <label class="col-sm-4 col-form-label">Menyusui</label>
    <div class="col-sm-12">
        ...
        <?= form_error('menyusui', '<small class="text-danger pl-3">', '</small>'); ?>
										...
										<div class="form-group row">
    <label class="col-sm-4 col-form-label">Riwayat Penyakit Sebelumnya</label>
    <div class="col-sm-12">
        <div class="row">
            <div class="col-sm-6">
        ...
        <?= form_error('riwayat_penyakit[]', '<small class="text-danger pl-3">', '</small>'); ?>
										...
										<div class="form-group row">
											<label class="col-sm-4 col-form-label">&emsp;Tekanan
													Darah</label>
											<div class="col-sm-12">
										...
										<div class="form-group row">
											<label class="col-sm-4 col-form-label">&emsp;Dalma
											</label>
											<div class="col-sm-12">
												<input type="text" name="dalma"
													class="form-control form-control-user" id="dalma" :
													value="<?= isset($rekam_medis['dalma']) ? $rekam_medis['dalma'] : ''; ?>">
										...
										<div class="form-group row">
											<label class="col-sm-4 col-form-label">&emsp;Riwayat Penyakit
											</label>
											<div class="col-sm-12">
												<input type="text" name="riwayat_penyakit"
													class="form-control form-control-user" id="riwayat_penyakit" :
													value="<?= isset($rekam_medis['riwayat_penyakit']) ? $rekam_medis['riwayat_penyakit'] : ''; ?>">
												<?= form_error('riwayat_penyakit', '<small class="text-danger pl-3">', '</small>'); ?>
											</div>
										</div>
										<!-- Kesadaran -->
