...
<script>
    // Inisialisasi Pusher
    var pusher = new Pusher('49930d4ebde6972b527c', {
        cluster: 'ap1',
        encrypted: true
    });

    // Subscribe ke channel 'rekam-medis'
    var channel = pusher.subscribe('resep-obat');

    // Tampilkan notifikasi saat menerima event 
    channel.bind('resep-event', function(data) {
        // Increment counter
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="<?=base_url('Apoteker/index')?>" aria-expanded="false">
                <span>
            ...
            <!-- <li class="nav-small-cap">
              ...
              <li class="sidebar-item">
              <a class="sidebar-link" href="<?=base_url('Apoteker/rekammedis')?>" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="<?=base_url('Apoteker/obat')?>" aria-expanded="false">
                <span>
                  <i class="ti ti-file-description"></i>
                </span>
...
<style>
  ...
  .custom-dropdown-menu {
    right: -150px; /* Menyesuaikan posisi dari kanan */
          ...
          <ul class="navbar-nav">
          <a id="notificationLink" class="nav-link dropdown-toggle" href="#"  aria-haspopup="true" aria-expanded="false">
        ...
        <a href="<?= base_url('Apoteker/profile/'); ?>" class="d-flex align-items-center gap-2 dropdown-item">
