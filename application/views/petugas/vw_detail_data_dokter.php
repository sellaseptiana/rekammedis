                    ...
                    <div class="card-body">
                        ...
                        <div class="card-block">
                            <form action="" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="id_user" value="<?= $unit_pelayanan['id_user']; ?>">
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <label class="col-sm-4 col-form-label"><strong>&emsp;&emsp;&emsp;Jenis Kelamin</strong>
                                            ...
                                            <br>
                                            <label class="col-sm-8 col-form-label">
                                                <td> : <?= $unit_pelayanan['jenis_kelamin']; ?></td>
                                            </label>
                                        </div>

                                        <div class="form-group row">
                                        <label class="col-sm-4 col-form-label"><strong>&emsp;&emsp;&emsp;Poliklinik</strong>
                                            </label>
                                            <br>
                                            <label class="col-sm-8 col-form-label">
                                                <td> : <?= $unit_pelayanan['nama_poli']; ?></td>
                                            </label>
                                        </div>
                                        <div class="form-group row">
