            ...
            <tbody><?php $i =1; ?>
                        <?php foreach ($user as $us) : ?>
                          ...
                          <td><?= $us['no_hp']; ?></td>
														...
														<td>
                             <a href="<?= base_url('Petugas/detail_apoteker/'). $us['id_user']; ?>"
															class="badge badge-warning">Detail</a> 
                        </div>
                              <a href="<?= base_url('Petugas/hapus/'). $us['id_user']; ?> "
    ...
    $(document).ready(function() {
        tabel = $('#table-user').DataTable({
            ...
            "columns": [
                ...
                { "data": "id_user",
                    "render": function(data, type, row, meta) {
                        return '<a href="<?= base_url('Petugas/detail_apoteker/'); ?>' + data + '" class="badge badge-warning">Detail</a> ' + '<a href="<?= base_url('Petugas/edit_apoteker/'); ?>' + data + '" class="badge badge-primary">Update</a> ' +
                           '<a href="<?= base_url('Petugas/hapus/'); ?>' + data + '" class="badge badge-danger" onclick="return confirm(\'Yakin untuk menghapus Data ini?\');">Hapus</a>';
                        }
            }
        ]
    });
