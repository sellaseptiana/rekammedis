...
<div class="container-fluid">
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card" style="background-color: rgba(245, 245, 245, 0.9);">
								<div class="card-header">
  							<h4 class="title"><strong>Tambah Data Dokter</strong></h4><br>
  							<div class="card-body">
  								<form action="" method="POST" enctype="multipart/form-data">
  									...
  									<div class="form-group row">
  										...
  										<div class="col-sm-10">
    <select name="id_poli" id="id_poli" class="form-control form-control-user">
    ...
    <?= form_error('id_poli', '<small class="text-danger pl-3">', '</small>'); ?>
  									...
  									<div class="form-group row">
  										...
  										<div class="col-sm-10">
  											<input type="teks" name="no_hp" value="<?= set_value('no_hp'); ?>"
									  ...
									  <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="username" value="<?= set_value('username'); ?>" class="form-control form-control-user" id="username" placeholder="Masukkan Username">
