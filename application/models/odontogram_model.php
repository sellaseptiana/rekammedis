...
class odontogram_model extends CI_Model
    {
        public $table = 'tb_odontogram';
	public $id = 'tb_odontogram.id_odontogram';
    ...
    {
        $this->db->from($this->table);
        $this->db->where('id_odontogram', $this->session->userdata('id_odontogram'));
        $query = $this->db->get();
    ...
    {
        $this->db->from($this->table);
        $this->db->where('id_odontogram',$id);
        $query = $this->db->get();
        $this->db->get_where($this->table, ["id_odontogram" => $id])->row();
        return $query->row_array();
    }
    ...
    {
        return $this->db->get('tbodontogram')->result_array();
    }
    public function insert($data) {
        $this->db->insert('tbodontogram', $data);
